...
<head>
    ...
    <link rel='stylesheet' id='full-descriptor-css' href='portfolios/full-description/css/style.css' type='text/css'
          media='all'/>

    <link rel='stylesheet' id='slide-details-css' href='portfolios/slide-detail/css/style.css' type='text/css'
          media='all'/>
    <link rel='stylesheet' id='flex-css' href='sliders/flexslider/css/slider.css' type='text/css' media='all'/>
    <link rel='stylesheet' id='flexslider-css' href='sliders/flexslider/css/flexslider.css' type='text/css'
          media='all'/>
    <link rel='stylesheet' id='flexslider-elegant-css' href='sliders/flexslider-elegant/css/flexslider.css'
          type='text/css' media='all'/>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="../../../webroot/apple-touch-icon-144x.png"/>
    <!-- For first- and second-generation iPad: -->
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="../../../webroot/apple-touch-icon-114x.png"/>
    <!-- For first- and second-generation iPad: -->
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="../../../webroot/apple-touch-icon-72x.png">
    <!-- For non-Retina iPhone, iPod Touch, and Android 2.1+ devices: -->
    <link rel="apple-touch-icon-precomposed" href="../../../webroot/apple-touch-icon-57x.png"/>
    <!-- For non-Retina iPhone, iPod Touch, and Android 2.1+ devices: -->
    <link rel="apple-touch-icon-precomposed" href="../../../webroot/apple-touch-icon-57x.png"/>
                        ...
                        <div class="row">
                            ...
                            <div id="logo" class="span4 group">
                                <a id="logo-img" href="index.html" title="Mon toit c'est toi">
                                    <img src="images/mes_images/dog-1484728_960_720.png" title="celestino"
                                         alt="Mon toit c'est toi" width="100px"/>
                                </a>
                                ...
                                <div id="portfolio" class="portfolio-full-description">
                                    <div class="portfolios type-portfolios status-publish hentry work group row">
                                            ...
                                            <div class="thumb-wrapper">
                                                <div class="work-thumbnail">
                                                    <div class="picture_overlay_empty picture_overlay">
                                                        <img width="574" height="340" src="images/mes_images/toutou.jpg"
                                                             class="attachment-thumb_portfolio_fulldesc" alt="004"/>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="work-description span6">
                                            ...
                                            <blockquote>
                                                <p>
                                                    Nullam volutpat, mauris scelerisque iaculis semper, justo odio
                                                    rutrum urna, at cursus urna nisl et ipsum. Donec dapibus lacus nec
                                                    sapien faucibus eget suscipit lorem mattis.
                                                    Donec non mauris ac nulla consectetur pretium sit amet rhoncus
                                                    neque. Maecenas aliquet, diam sed rhoncus vestibulum, sem lacus
                                                    ultrices est, eu hendrerit tortor nulla in dui.
                                                </p>
                                            </blockquote>
                                            <div></div>
                                            ...
                                            <div class="work-skillsdate span6">
                                                ...
                                                <p class="customer">
                                                    <span class="meta-label">Sexe</span> Male
                                                </p>
                                                <p class="workdate">
                                                    <span class="meta-label">Age</span> 3 mois
                                                </p>
                                                <p class="categories paragraph-links">
                                                    <span class="meta-label">Race</span> toutou
                                                </p>
                                                <p class="role">
                                                    <span class="meta-label">Etat</span> Adoptable
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class=" widget span3 last">
                            <div class="list-tweets-2">
                                <ul style="margin-left: 30%;">
                                    <br>
                                    <li>
                                        <a href="https://www.facebook.com/montoitcesttoi"><img
                                                src="images/mes_images/icon-fb.png"></a>
                                    </li>
                                    <br>
                                    <li><a href="#"><img
                                            src="images/icons/set_icons/letter32.png"></a>
                                    </li>
