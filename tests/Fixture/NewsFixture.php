...
class NewsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'news_ibfk_1' => ['type' => 'foreign', 'columns' => ['image_id'], 'references' => ['images', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'image_id' => 1,
            'created' => '2016-09-01 12:40:00',
            'modified' => '2016-09-01 12:40:00'
        ],
    ];
}
